...
public class SceneLoader implements LoaderTask.Callback {
     ...
     * Parent component
     */
    protected final Pagoda3DViewerActivity parent;
    /**
    ...
    public SceneLoader(Pagoda3DViewerActivity main) {
        this.parent = main;
    }
    ...
    public void setRotatingLight(boolean rotatingLight) {
        this.rotatingLight = rotatingLight;
    }
